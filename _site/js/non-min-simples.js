...
function(t, e, i, n) {
    ...
    s.Defaults = {
        ...
        3 !== e.which && (t.support.transform ? n = {
                ...
                y: n.top
            }), this.is("animating") && (t.support.transform ? this.animate(n.x) : this.$stage.stop(), this.invalidate("position")), this.$element.toggleClass(this.options.grabClass, "mousedown" === e.type), this.speed(0), this._drag.time = (new Date).getTime(),
            this._drag.target = t(e.target), this._drag.stage.start = n, this._drag.stage.current = n, this._drag.pointer = this.pointer(e), t(i).on("mouseup.owl.core touchend.owl.core", t.proxy(this.onDragEnd, this)), t(i).one("mousemove.owl.core touchmove.owl.core", t.proxy(function(e) {
...
function(t) {
    ...
    s.Adapter.bind(window, "statechange", function() {
        ...
        t(this).hasClass("js-no-ajax") || /^#/.test(o) || o.indexOf("mailto:") >= 0 || o.indexOf("tel:") >= 0 ? window.location = o : t(this).is(".gallery__item__link") || (o.indexOf("http") >= 0 ? window.open(o, "_blank") : (i = o, s.pushState(null, n, o)))
    }), e(), t(document).on("submit", "#contact-form", function(e) {
