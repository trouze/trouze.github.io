---
title: /now
description: What Tyler Rouze is up to right now — work, life, and current interests.
---

<img src="/images/austin.jpg" alt="Austin, TX">
...
I currently volunteer at [Marbridge](https://www.marbridge.org/), a residential community for adults with a wide range of cognitive disabilities, putting on Bingo every Thursday night for residents.
...
I have quite a passion for lifelong learning. More formally, I earned my Bachelors degree from the University of Minnesota in [Industrial and Systems Engineering](https://cse.umn.edu/isye). The IE curriculum covers the science of decision-making — Statistics, Optimization, and Simulation — which sparked my passion for data-driven solutions.

### How can I get in touch?

Send me an email to tyler @ this domain, or [subscribe to the mailing list](/subscribe/) for updates delivered straight to your inbox.

---

This page is inspired by [Derek Sivers](https://sive.rs/now) and listed on [nownownow](https://nownownow.com/p/KFYB).
