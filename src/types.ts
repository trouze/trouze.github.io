export interface ProfileConfig {
	...
	mastodon?: string;
	/** Strava profile URL. Leave empty to hide. */
	strava?: string;
	/** Spotify profile URL. Leave empty to hide. */
	spotify?: string;
	/** YouTube channel URL. Leave empty to hide. */
	youtube?: string;
	/** VSCO profile URL. Leave empty to hide. */
	vsco?: string;
